...
- After submitting, the picker card is replaced by a single result card showing the whole flag twice side by side — once with your guessed colour and once with the actual colour — along with your score.
